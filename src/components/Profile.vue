        ...
        <div class="space-y-5 lg:col-span-2">
          ...
          <div class="p-7 pb-0 block-section">
            ...
            <p class="text-gray-600 mb-5">
              ...
              constante de evolução. Especializado em Python e .NET, participei do desenvolvimento
              de projetos que impactaram mais de 240 mil clientes. Atualmente, sou membro da equipe
            ...
            <div class="mb-5 item-section">
              ...
              <div class="w-full space-y-5">
                ...
                <p class="text-gray-600">
                  Aut omnis voluptatem sit sequi. Voluptatem temporibus repellat voluptatem
                  voluptatibus enim voluptas necessitatibus. Aut quasi sunt dolor. Commodi dolores
                  saepe asperiores beatae voluptate corporis est ea voluptatem. Enim quo sed et sint
          ...
          <div class="p-7 block-section">
            ...
            <div class="mb-5 item-section">
              <div
                class="flex-shrink-0 w-12 h-12 rounded-xl bg-cover"
                style="background-image: url('assets/img/bu-logo.jpg')"
              ></div>
