<template>
  <div class="flex flex-col text-2xl align-middle pl-96 pr-96 h-full justify-center">
    <div class="contact-line contact-line-title flex justify-center p-5">
    ...
    <div
      class="contact-line contact-line-title text-[#181717] dark:text-[#E6EDF3] flex justify-center p-5"
    >
    ...
    <div class="contact-line contact-line-title text-[#0A66C2] flex justify-center p-5">
    ...
    <div class="contact-line contact-line-title text-[#E4405F] flex justify-center p-5">
      <span class="rounded bg-opacity-10 p-1"
        ><svg
          xmlns="http://www.w3.org/2000/svg"
          width="1em"
